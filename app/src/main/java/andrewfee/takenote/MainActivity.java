...
//
//Summary: This is the launcher activity that serves as
//the main entry point to the app's user interface.
//
public class MainActivity extends AppCompatActivity
{
    ...
    private class FetchTask extends AsyncTask<Void, Void, ArrayList<Note>> {
        ...
        protected ArrayList<Note> doInBackground(Void... params) {
            DbHelper db = DbHelper.getInstance(MainActivity.this.getApplicationContext());
        ...
        protected void onPostExecute(ArrayList<Note> notes) {
            ...
            Toast toast = Toast.makeText(MainActivity.this.getApplicationContext(), msg, Toast.LENGTH_LONG);
            toast.show();
        }
    }
